...
using si730ebirriot.API.Shared.Infrastructure.Interfaces.ASP.Configuration.Extensions;

namespace si730ebirriot.API.Shared.Infrastructure.Interfaces.ASP.Configuration;
